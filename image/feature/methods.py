...
@check_image_exist_external
def blob_diff_gaussian(image: BaseImage, sigma_min: Optional[float] = 1.0, sigma_max: Optional[float] = 50.0, sigma_ratio: Optional[float] = 1.6, threshold: Optional[float] = 0.5, overlap: Optional[float] = 0.5):
...
@check_image_exist_external
def blob_determinant_hessian(image: BaseImage, sigma_min: Optional[float] = 1.0, sigma_max: Optional[float] = 50.0, sigma_ratio: Optional[float] = 1.6, sigma_num: Optional[Union[int, float]] = 10, overlap: Optional[float] = 0.5):
    """Compute blobs in a grayscale image using difference of gaussian method"""
